...
public class Consts {
    ...
    public static final long URL_SIZE_LENGTH = 4;
    ...
    public static final long REFER_URL_SIZE_LENGTH = 4; 
    public static final long REFER_URL_POSITION = REFER_URL_SIZE_POSITION + REFER_URL_SIZE_LENGTH;
    public static final long FOLDER_POSITION = REFER_URL_POSITION + REFER_URL_LENGTH;
    public static final long FILE_NAME_POSITION = FOLDER_POSITION + FOLDER_LENGTH;
